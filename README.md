...
## In this project, I deliberately chose to build my Slack integration with plain Spring MVC instead of using the Bolt framework,
## so I could dive deep into the underlying HTTP mechanics, REST controllers, middleware and etc.
